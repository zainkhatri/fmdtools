...
# -*- coding: utf-8 -*-
"""
AutonomousVehicle level model.

Autonomous vehicle system with AI, sensors, and safety systems
Generated by fmdtools CLI
"""

from .architecture import Autonomousvehiclearchitecture
import fmdtools.sim.propagate as prop


class Autonomousvehicle(Autonomousvehiclearchitecture):
    """AutonomousVehicle main model class."""
...
if __name__ == "__main__":
    ...
    print(f"AutonomousVehicle Model")
    print("=" * 40)
    ...
    print(f"\nAutonomousVehicle model is ready!")
